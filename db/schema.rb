...
ActiveRecord::Schema[7.0].define(version: 2023_03_26_202225) do
  ...
  create_table "favourites", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["monument_id"], name: "index_favourites_on_monument_id"
  ...
  add_foreign_key "favourites", "monuments"
